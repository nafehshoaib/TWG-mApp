...
//  mApp
//
//  Created by Nafeh Shoaib on 2016-08-12.
...
class Office {
    ...
    init(filename: String) {
        ...
        let midPoint = NSPointFromString(properties!["midCoord"] as! String)
        midCoordinate = CLLocationCoordinate2DMake(CLLocationDegrees(midPoint.x), CLLocationDegrees(midPoint.y))
        
        let overlayTopLeftPoint = NSPointFromString(properties!["overlayTopLeftCoord"] as! String)
        ...
        let overlayTopRightPoint = NSPointFromString(properties!["overlayTopRightCoord"] as! String)
        ...
        let overlayBottomLeftPoint = NSPointFromString(properties!["overlayBottomLeftCoord"] as! String)
        ...
        for i in 0...boundaryPointsCount-1 {
            let p = NSPointFromString(boundaryPoints[i] as! String)
